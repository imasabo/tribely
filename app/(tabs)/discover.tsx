...
import { discoverFilters, discoverLessons, discoverSortOptions } from '@/data/lessons';
  ...
  return (
    <ScrollView
      ...
      <View className="mb-3 flex-row items-center justify-between px-5">
        <Text className="text-sm text-muted-foreground">{discoverLessons.length} lessons found</Text>
        ...
        {discoverLessons.map((lesson) => (
          <Pressable
            ...
            <View className="flex-1 justify-center">
              ...
              <Text className="mt-0.5 text-xs text-muted-foreground">{lesson.teacher}</Text>
              <View className="mt-2 flex-row items-center justify-between">
                ...
                {lesson.price != null && (
                  <Text className="text-sm font-semibold text-primary">${lesson.price}</Text>
                )}
              </View>
            </View>
          </Pressable>
