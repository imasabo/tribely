        ...
        <View className="px-5 pt-5">
          <View className="mb-3 flex-row gap-2">
            <View className="rounded-full bg-secondary px-2.5 py-1">
              <Text className="text-xs font-medium text-primary">{lesson.duration} min lesson</Text>
            </View>
          ...
          <View className="mb-5 flex-row items-center gap-3">
            ...
            <View className="flex-1">
              <Text className="font-semibold text-foreground">{lesson.teacher}</Text>
          ...
          <View className="mb-5 gap-3 rounded-2xl border border-border bg-card p-4">
            <View className="flex-row items-center gap-3">
              ...
              <Text className="text-sm text-foreground">{lesson.time}</Text>
            </View>
            <View className="flex-row items-center gap-3">
              <Feather name="map-pin" size={16} color="#0F766E" />
              <Text className="flex-1 text-sm text-foreground">{lesson.location}</Text>
            </View>
            <View className="flex-row items-center gap-3">
              <Feather name="navigation" size={16} color="#0F766E" />
              <Text className="text-sm text-foreground">{lesson.distance} away</Text>
            </View>
          </View>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} className="mb-4">
            {[0, 1, 2].map((i) => (
              <View
                ...
                <LinearGradient
                  colors={i === 0 ? [lesson.slidePreviewColors[0], lesson.slidePreviewColors[1]] : ['#374151', '#1F2937']}
