  ...
  return (
    <ScrollView
      ...
      <View className="relative">
        <LinearGradient colors={[colors.primary, colors.primaryDark]} style={{ height: 128 }} />
      ...
      <View className="bg-background px-5 pb-5">
        ...
        <View className="mt-4 flex-row gap-2">
          {[
            { label: 'Rating', value: '4.9', icon: 'star' as const, color: colors.accent },
            { label: 'Taught', value: '12', icon: 'book-open' as const, color: colors.primary },
